...
//Getting order info 
$result = getJSONFromDB("select orders.order_id, items.item_name, customer.customer_name, customer.customer_contact_no, orders.order_quantity, orders.order_date, orders.total_price from orders inner join items on orders.item_id = items.item_id INNER join customer on orders.customer_id = customer.customer_id where manager_id = $managerId");
